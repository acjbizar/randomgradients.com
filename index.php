...
$r .= '<meta itemprop=image content=https://randomgradients.com/apple-touch-icon-precomposed.png>';
...
$r .= '<meta property=og:image content=https://randomgradients.com/apple-touch-icon-precomposed.png>';
$r .= '<meta property=og:title content="Random Gradients">';
$r .= '<meta property=og:type content=website>';
$r .= '<meta property=og:url content=https://randomgradients.com/>';
$r .= '<title itemprop=name>Random Gradients</title>';
$r .= '<link rel=apple-touch-icon-precomposed href=https://randomgradients.com/apple-touch-icon-precomposed.png>';
$r .= '<link rel=author href=https://alexanderchristiaanjacob.com/>';
$r .= '<link rel=canonical href=https://randomgradients.com/>';
$r .= '<link rel=stylesheet href=https://mimesia.net/style/foundation-icons.css>';
$r .= '<style>';
...
JS;
$r .= '</script>';
$r .= '<a class=fi-shuffle href=https://randomgradients.com/ itemprop=url></a>';
